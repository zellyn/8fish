...
func asmHeader(entryCount, nameCount, blobSize int) string {
	...
	b.WriteString("; Resident opening book layout. The blob is delivered ONCE from the\n")
	b.WriteString("; disk in its SECOND stage, is lifted to AUXILIARY RAM $0200 by the copier\n")
	b.WriteString("; in asm/m8.s, and stays resident there. It used to live in the hi-res\n")
	b.WriteString("; page-1 hole at main $2000; the DHGR board needed those 8 KB.\n")
